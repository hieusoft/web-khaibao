                ...
                {parentNavItems.map((item) => {
                  ...
                  return (
                    <Link
                      key={item.path}
                      to={item.path}
                      className={`px-5 lg:px-6 py-3 text-sm lg:text-base font-medium transition-all whitespace-nowrap flex items-center gap-2 ${
                        isActive
                          ? 'bg-[#F9ECC2] text-[#9F0712FF]'
                          ...
                          <div className="bg-gray-50">
                            {getChildNavItems(section.name).map((child) => (
                              <Link
                                ...
                                className={`block px-8 py-3 text-sm transition-colors flex items-center gap-3 ${
                                  isActive(child.path)
